 ...
 */
package com.xinkun.b2b.test.setup;
...
import com.xinkun.b2b.test.constants.Xinkunb2bTestConstants;
import com.xinkun.b2b.test.orders.AcceleratorTestOrderData;
 ...
 */
@SystemSetup(extension = Xinkunb2bTestConstants.EXTENSIONNAME)
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			importImpexFile(context, "/xinkunb2btest/import/qa-test-users.impex");

			LOG.info("Creating Reviews...");
			importImpexFile(context, "/xinkunb2btest/import/reviews.impex");
			...
			importImpexFile(context, "/xinkunb2btest/import/cstickets.impex");
		}
	}
}
