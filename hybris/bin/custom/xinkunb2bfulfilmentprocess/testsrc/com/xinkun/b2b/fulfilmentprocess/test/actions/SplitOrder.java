 ...
 */
package com.xinkun.b2b.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception //NOPMD
	{
		...
		warehouseCounter.setName(Xinkunb2bFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(Xinkunb2bFulfilmentProcessConstants.PARENT_PROCESS);
